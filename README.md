...
* "FEM" in the figure, means the purely physics-based models, where we intentionally introduce model noise into the model, and we integrate this "inaccurate" model with observational data  
